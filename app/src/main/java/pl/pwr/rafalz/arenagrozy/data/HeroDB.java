...
public class HeroDB {
    ...
    public static Hero getHero(int whichHero) {
        ...
        switch (whichHero) {
            ...
            case 1:
                //stats
                statsBuilder.setHpStart(getLife(LIFE_HIGH, cLevels[0]))
                        .setStrStart(getStrength(STRENGTH_LOW, cLevels[1]))
                        .setDefStart(getDefense(DEFENSE_HIGH, cLevels[2]));

                h = new Hero(sW, 4 * sH, R.drawable.fox_walk, 8, R.drawable.fox_stay, 8, 1f, 1, statsBuilder.build());
                ...
                break;
            case 2:
                h = new Hero(sW * 2, 6 * sH, R.drawable.fox_walk, 8, R.drawable.fox_stay, 8, 1f, 2, statsBuilder.build());
                p = new Pointer(0, 0, h.getWidth() / 3);
                ...
                //stats
                statsBuilder.setHpStart(getLife(LIFE_LOW, cLevels[0]))
                        .setStrStart(getStrength(STRENGTH_HIGH, cLevels[1]))
                        .setDefStart(getDefense(DEFENSE_LOW, cLevels[2]));
                ...
                break;
            case 3:
                h = new Hero(sW * 3, 4 * sH, R.drawable.fox_walk, 8, R.drawable.fox_stay, 8, 1f, 3, statsBuilder.build());
                p = new Pointer(0, 0, h.getWidth() / 3);
                ...
                //stats
                statsBuilder.setHpStart(getLife(LIFE_MEDIUM, cLevels[0]))
                        .setStrStart(getStrength(STRENGTH_LOW, cLevels[1]))
                        .setDefStart(getDefense(DEFENSE_MEDIUM, cLevels[2]));
